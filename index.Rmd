...
* The [RStudio R Markdown website](https://rmarkdown.rstudio.com/) contains [lessons](https://rmarkdown.rstudio.com/lesson-1.html), a [gallery of possibilities](https://rmarkdown.rstudio.com/gallery.html) and [a number of other articles](https://rmarkdown.rstudio.com/articles.html)

# Intro

## Purpose

This document was originally used in a Coffee & Coding session in a public-sector organisation.
The blurb:
