...
<img src="img/consultancy-cup_mon-aguilar_noun_110144_cc.png" alt="CC BY 3.0, Consultancy Cup icon by Mon Aguilar from thenounproject.com" height="200" width="200"><img src="img/yarn-ball_andrejs-kirma_noun_871187_cc.png" alt="CC BY 3.0, Yarn Ball icon by Andres Kirma from thenounproject.com" height="200" width="200">
...
[reference guide](https://www.rstudio.com/wp-content/uploads/2015/03/R Markdown-reference.pdf). The most in-depth source of information is probably the [RStudio R Markdown website](https://R Markdown.rstudio.com/).
...
4. Render the document -- *knit* it -- to turn your R Markdown into a 'proper' document for sharing
...
<img src="img/md_CC0_208x128.png" alt="CC0 Markdown logo by Dustin Curtis" height="100" width="100">
...
<img src="img/pikachu_gamze-genc-celik_noun_1074643_cc.png" alt="CC BY 3.0, Pikachu icon by Gamze Genc Celik from thenounproject.com" height="150" width="150"> <font size="25"><</font> <img src="img/squirtle_gamze-genc-celik_noun_1074642_cc.png" alt="CC BY 3.0, Squirtle icon by Gamze Genc Celik from thenounproject.com" height="150" width="150">
...
<img src="img/chicken_aline-escobar-noun_1368420_cc.png" alt="CC BY 3.0, Chicken icon by Aline Escobar from thenounproject.com" height="150" width="150"><img src="img/chicken_aline-escobar-noun_1368420_cc.png" alt="CC BY 3.0, Chicken icon by Aline Escobar from thenounproject.com" height="150" width="150">
...
In other words you'll get the output table as you wanted, but the code itself will also print out.

Okay, but we probably don't want the code to be exposed to the reader; it's the output we care about. We can fix this with chunk options.
...
<img src="img/squirrel_alex-muravev_noun_1072491_cc.png" alt="CC BY 3.0, Squirrel icon by Alex Muravev from thenounproject.com" height="150" width="150">
...
* *output created*: the document has been successfully produced

The document won't knit if there are errors in the code. The offending code will be pointed out with the name of the chunk it's in and the line it starts. I won't go into all the errors here, but they'll probably be related to the code sections.
...
<img src="img/httpsrmarkdown.rstudio.comlesson-2html.png" alt="R Studio" height="200" width="500">
...
* [Notebooks](https://R Markdown.rstudio.com/r_notebooks.html)
...
* Word
* Other output formats: Presentations, Flexdashboard, Bookdown, Shiny, Websites, R Notebooks, crosstalk
* More about Knitr upfront
* table formatting with kable()
* execute other coding languages in chunks?
* test git push from bash vs rstudio terminal